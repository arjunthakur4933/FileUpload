...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to arjunnew");
        const response = await uploadFileToCloudinary(file, "arjunnew");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "arjunnew", 90);
        console.log(response);
